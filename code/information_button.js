function createInfoButtonWithTooltip(containerId, plotTitle, whatAreYouLookingAt, xAxis, yAxis, marks, whatCanYouDo, left_right) {
    ...
    tooltip.appendChild(createTooltipLine("What are you looking at:", whatAreYouLookingAt));
    ...
    tooltip.appendChild(createTooltipLine("What can you do with it:", whatCanYouDo));
